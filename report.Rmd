...
#!   read random_numbers6 from output directory
random_numbers6 <- readRDS(
  here::here("output/random_numbers6.rds")
)

#!   read random_numbers6 from output directory
random_numbers7 <- readRDS(
  here::here("output/random_numbers7.rds")
)
```
...
```{r, random-numbers6-histogram}
#| fig.cap = "Sixth set of random numbers"
hist(random_numbers6)
```

# Random numbers 7

```{r, random-numbers7-histogram}
#| fig.cap = "Seventh set of random numbers"
hist(random_numbers7)
```